...
import "../RelatedProducts/RelatedProducts.component.css";
...
import { ArrowRepeat, ArrowsMove, Cart3, CheckCircle, ChevronLeft, ChevronRight, Dash, Heart, HeartFill, Plus, Star, StarFill, StarHalf } from "react-bootstrap-icons";
                ...
                <Slider ref={sliderRef} {...settings}>
                {
                    ...
                    <div className="related-full">
                        <div className="related-img" >
                        {
                                    ...
                                    {
                                        !iteam.product_image && <img src={Farm15} alt="" />
                                    }
                        </div>
                        ...
                        <div className="related-disp ">
                            <h6>{iteam.soldby}</h6>
                            <h6 className="related-disp-dis" >{iteam.product_name}</h6>
                        </div>
                        <div className="related-sale">
                            ...
                            <br />
                            <span className="related-rate">${iteam.newprice}</span><del>${iteam.oldprice}</del>
                            <br />
                        </div>
                        <div className="related-cart">
                            <div className="related-quantity">
                                <span><Dash onClick={() => { 
