...
import "../Essential/EssentialProduct.component.css";
...
import { ShopingCart } from "../Cart/cart.component";
...
export function EssentialProduct() {
...
addcomparemsg && <label className="compare-pop"><ArrowRepeat></ArrowRepeat> your product add to compare</label>
}
{

addcartmsg && <label className="compare-pop"><CheckCircle></CheckCircle> your product added to cart</label>
}
