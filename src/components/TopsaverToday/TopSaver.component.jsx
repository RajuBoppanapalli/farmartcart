...
import mart21 from "../../assets/images/mart21.jpg";
    ...
    return (
        <>
            ...
            <div className="slider-container">
                <div className="Topsaver-head">
                    <h4>Top Saver Today</h4>
                    <div>
                        <span >All Offers <ChevronRight className="offer" size={20} ></ChevronRight> </span>
                    </div>
                    <div className="Topsaver-expires">
                        <span>&nbsp; Expires in : &nbsp;06 : 56 : 07 &nbsp;</span>
                    </div>
                    <div className="Topsaver-arrow">
                ...
                <Slider ref={sliderRef} {...settings}>
                    {
                        farmartProducts && farmartProducts.map((iteam, index) =>
                            ...
                            <div className="Topsaver-full">
                                ...
                                <div className="Topsaver-disp ">
                                    <h6>{iteam.soldby}</h6>
                                    <h6 className="Topsaver-disp-dis" >{iteam.product_name}</h6>
                                </div>
                                <div className="Topsaver-sale">
                                    ...
                                    <br />
                                    <span className="Topsaver-rate">${iteam.newprice} </span><del>${iteam.oldprice}</del>
                                    <br />
                                    <span><ProgressBar variant="warning" className="mt-2" now={now} label={`${now}%`} /></span>

                                    <span>Sold:{now}%</span>
                                </div>
                                <div className="Topsaver-cart">
                                    <div className="Topsaver-quantity">
                                        <span><Dash onClick={() => {
                                    ...
                                    <Button variant="warning" className="mt-2" onClick={() => { handleaddtocart(iteam.product_id)}} ><Cart3 className="m-2 mt-0"></Cart3>Add To Cart</Button>                                </div>
                            </div>
